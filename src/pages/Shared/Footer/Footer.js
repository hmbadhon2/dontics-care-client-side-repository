...
const Footer = () => {
    return (
        <div className=''>
            <footer className="footer p-10 lg:px-24 bg-sky-900 text-sky-50 text-base-content">
  <div>
    <span className="footer-title">Services</span> 
    <Link className="link link-hover text-base font-semibold "> General Dentistry</Link>
    <Link className="link link-hover"> Cosmetic Dentistry</Link>
    <Link className="link link-hover"> Periodontal Dentistry</Link>
    <Link className="link link-hover"> Orthodontic Dentistry</Link>
    <Link className="link link-hover"> Pediatric Dentistry</Link>
    <Link className="link link-hover"> Endodontic Dentistry</Link>
...
<footer className="footer px-10 py-4 border-t bg-sky-900 text-sky-50 border-base-300">
  <div className="items-center grid-flow-col">
    ...
    <p> Dontics Care. <br/>Providing Providing a dental service  since 2018</p>
  </div> 
